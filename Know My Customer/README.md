...
[![Copilot Studio](https://img.shields.io/badge/Copilot_Studio-Agent-742774?logo=microsoft&logoColor=white)](https://copilotstudio.microsoft.com)
...
| [`Know My Customer Agent - Evaluation Test Plan.docx`](Know%20My%20Customer%20Agent%20-%20Evaluation%20Test%20Plan.docx) | Detailed evaluation test plan with 15 test scenarios and pass/fail criteria |
| [`Know My Customer Agent - Evaluation Test Set.csv`](Know%20My%20Customer%20Agent%20-%20Evaluation%20Test%20Set.csv) | CSV test set importable into Copilot Studio for automated evaluation |
| [`Know My Customer Agent - Word Template.docx`](Know%20My%20Customer%20Agent%20-%20Word%20Template.docx) | Word document template with content controls used by the file generation flow |
...
| [`Know My Customer Icon.png`](Know%20My%20Customer%20Icon.png) | Agent icon (PNG) for Teams and Copilot Studio branding |
